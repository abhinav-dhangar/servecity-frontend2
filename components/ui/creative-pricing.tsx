...
function CreativePricing({
  tag = "About Our Creative Team",
  title = "We made this together",
  description = "Our team culture is everything to us – caring for each other and growing together.",
  tiers,
}: {
  tag?: string;
  title?: string;
  ...
  return (
    <div className="w-full max-w-6xl mb-12  mt-6 mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {tiers.map((tier, index) => (
          ...
          >
            {/* <Image src={"/goth.gif"} fill className="object-cover" /> */}
            <div
              className={cn(
            ...
            <div className="relative p-6">
              ...
              <div className="mb-6">
                ...
                <div
                  className="w-48 h-48 my-2 rounded-xl overflow-hidden relative
              ...
              >
                Go To LinkedIn <ArrowUpRight className="ml-1" />
              </Button>
            </div>
          </div>
        ))}
